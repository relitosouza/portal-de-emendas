    ...
    return <>
        ...
        <main className="min-h-screen bg-slate-100 print:bg-white">
            <div className="print-container mx-auto my-8 min-h-[1123px] max-w-[980px] bg-white px-10 py-9 shadow-xl print:my-0 print:shadow-none">
                ...
                {groups.length === 0 ? <div className="border border-dashed border-slate-300 px-6 py-12 text-center text-sm text-slate-500">Nenhuma emenda encontrada para os filtros informados.</div> : <div className="space-y-6">{groups.map(group => <section key={group.objective} className="break-inside-avoid overflow-hidden border border-slate-200">
